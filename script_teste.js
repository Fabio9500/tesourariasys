...
const GH_FILE = 'dados_teste.json'; // build de TESTE — nunca toca nos dados reais
...
const ARQ_ANO = ano => `lancamentos_teste_${ano}.json`; // build de TESTE
...
// ══════════════════════════════════════════
const VERSAO = 'v2.0-teste-arquivamento';
